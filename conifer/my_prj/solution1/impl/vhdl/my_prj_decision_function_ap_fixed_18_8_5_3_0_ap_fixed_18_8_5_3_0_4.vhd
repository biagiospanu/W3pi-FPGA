...
entity my_prj_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_4 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of my_prj_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_4 is 
...
attribute shreg_extract : string;
    ...
    component my_prj_sparsemux_33_4_11_1_0_x0 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_33_4_11_1_0_x0_U47 : component my_prj_sparsemux_33_4_11_1_0_x0
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "0000",
    ...
    icmp_ln4_52_fu_184_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_1C80)) else "0";
    icmp_ln4_53_fu_190_p2 <= "1" when (signed(x_9_val_int_reg) < signed(ap_const_lv18_3FD94)) else "0";
    icmp_ln4_54_fu_196_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_1880)) else "0";
    icmp_ln4_55_fu_202_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_9FA)) else "0";
    icmp_ln4_56_fu_208_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_DE00)) else "0";
    icmp_ln4_57_fu_214_p2 <= "1" when (signed(x_7_val_int_reg) < signed(ap_const_lv18_3FA00)) else "0";
    icmp_ln4_58_fu_220_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_3780)) else "0";
    icmp_ln4_59_fu_226_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_2D80)) else "0";
    icmp_ln4_60_fu_232_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_7280)) else "0";
    icmp_ln4_61_fu_238_p2 <= "1" when (signed(x_9_val_int_reg) < signed(ap_const_lv18_3FE6C)) else "0";
    icmp_ln4_62_fu_244_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3080)) else "0";
    icmp_ln4_63_fu_250_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_16B4B)) else "0";
    icmp_ln4_64_fu_256_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_880)) else "0";
    icmp_ln4_65_fu_262_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_16382)) else "0";
    icmp_ln4_fu_178_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_E21A)) else "0";
