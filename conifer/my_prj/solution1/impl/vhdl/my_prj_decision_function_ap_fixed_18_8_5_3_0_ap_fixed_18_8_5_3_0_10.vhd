...
entity my_prj_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_10 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of my_prj_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_10 is 
...
attribute shreg_extract : string;
    ...
    component my_prj_sparsemux_31_4_11_1_0_x1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_31_4_11_1_0_x1_U147 : component my_prj_sparsemux_31_4_11_1_0_x1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "0000",
    ...
    icmp_ln4_124_fu_186_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_F000)) else "0";
    icmp_ln4_125_fu_192_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_6780)) else "0";
    icmp_ln4_126_fu_198_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_880)) else "0";
    icmp_ln4_127_fu_204_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_17418)) else "0";
    icmp_ln4_128_fu_210_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_9DF)) else "0";
    icmp_ln4_129_fu_216_p2 <= "1" when (signed(x_9_val_int_reg) < signed(ap_const_lv18_88)) else "0";
    icmp_ln4_130_fu_222_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_CFA)) else "0";
    icmp_ln4_131_fu_228_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_5680)) else "0";
    icmp_ln4_132_fu_234_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_126CE)) else "0";
    icmp_ln4_133_fu_240_p2 <= "1" when (signed(x_8_val_int_reg) < signed(ap_const_lv18_13C)) else "0";
    icmp_ln4_134_fu_246_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_1535C)) else "0";
    icmp_ln4_135_fu_252_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_AC80)) else "0";
    icmp_ln4_136_fu_258_p2 <= "1" when (signed(x_4_val_int_reg) < signed(ap_const_lv18_364)) else "0";
    icmp_ln4_fu_180_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_D80)) else "0";
