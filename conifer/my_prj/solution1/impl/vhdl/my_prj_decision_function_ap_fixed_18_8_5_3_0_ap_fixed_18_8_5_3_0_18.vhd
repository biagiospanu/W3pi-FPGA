...
entity my_prj_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_18 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of my_prj_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_18 is 
...
attribute shreg_extract : string;
    ...
    component my_prj_sparsemux_33_4_12_1_0 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_33_4_12_1_0_U1 : component my_prj_sparsemux_33_4_12_1_0
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "0000",
    ...
    icmp_ln4_66_fu_184_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_FE9B)) else "0";
    icmp_ln4_67_fu_190_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_E7F8)) else "0";
    icmp_ln4_68_fu_196_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_107F8)) else "0";
    icmp_ln4_69_fu_202_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_1180)) else "0";
    icmp_ln4_70_fu_208_p2 <= "1" when (signed(x_4_val_int_reg) < signed(ap_const_lv18_160)) else "0";
    icmp_ln4_71_fu_214_p2 <= "1" when (signed(x_4_val_int_reg) < signed(ap_const_lv18_754)) else "0";
    icmp_ln4_72_fu_220_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_2780)) else "0";
    icmp_ln4_73_fu_226_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_1280)) else "0";
    icmp_ln4_74_fu_232_p2 <= "1" when (signed(x_8_val_int_reg) < signed(ap_const_lv18_1D8)) else "0";
    icmp_ln4_75_fu_238_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_F32)) else "0";
    icmp_ln4_76_fu_244_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_5F66)) else "0";
    icmp_ln4_77_fu_250_p2 <= "1" when (signed(x_4_val_int_reg) < signed(ap_const_lv18_387)) else "0";
    icmp_ln4_78_fu_256_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_FD8)) else "0";
    icmp_ln4_79_fu_262_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_4980)) else "0";
    icmp_ln4_fu_178_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_1B80)) else "0";
