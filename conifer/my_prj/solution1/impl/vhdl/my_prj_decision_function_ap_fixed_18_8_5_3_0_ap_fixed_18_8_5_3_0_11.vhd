...
entity my_prj_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_11 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of my_prj_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_11 is 
...
attribute shreg_extract : string;
    ...
    component my_prj_sparsemux_19_4_11_1_0 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_19_4_11_1_0_U139 : component my_prj_sparsemux_19_4_11_1_0
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "0000",
    ...
    icmp_ln4_137_fu_136_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_6DA)) else "0";
    icmp_ln4_138_fu_142_p2 <= "1" when (signed(x_8_val_int_reg) < signed(ap_const_lv18_31)) else "0";
    icmp_ln4_139_fu_148_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_7D80)) else "0";
    icmp_ln4_140_fu_154_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_3580)) else "0";
    icmp_ln4_141_fu_160_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_9B8)) else "0";
    icmp_ln4_142_fu_166_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_910)) else "0";
    icmp_ln4_143_fu_172_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_4A80)) else "0";
    icmp_ln4_fu_130_p2 <= "1" when (signed(x_7_val_int_reg) < signed(ap_const_lv18_600)) else "0";
