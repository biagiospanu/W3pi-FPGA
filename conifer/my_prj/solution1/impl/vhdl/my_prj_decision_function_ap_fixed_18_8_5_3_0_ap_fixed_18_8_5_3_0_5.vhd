...
entity my_prj_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_5 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of my_prj_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_5 is 
...
attribute shreg_extract : string;
    ...
    component my_prj_sparsemux_31_4_12_1_0 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_31_4_12_1_0_U37 : component my_prj_sparsemux_31_4_12_1_0
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "0000",
    ...
    icmp_ln4_46_fu_194_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_3080)) else "0";
    icmp_ln4_47_fu_200_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_2680)) else "0";
    icmp_ln4_48_fu_206_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_A80)) else "0";
    icmp_ln4_49_fu_212_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_1980)) else "0";
    icmp_ln4_50_fu_218_p2 <= "1" when (signed(x_7_val_int_reg) < signed(ap_const_lv18_600)) else "0";
    icmp_ln4_51_fu_224_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_1260)) else "0";
    icmp_ln4_52_fu_230_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_1C80)) else "0";
    icmp_ln4_53_fu_236_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_2580)) else "0";
    icmp_ln4_54_fu_242_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_C000)) else "0";
    icmp_ln4_55_fu_248_p2 <= "1" when (signed(x_8_val_int_reg) < signed(ap_const_lv18_1C4)) else "0";
    icmp_ln4_56_fu_254_p2 <= "1" when (signed(x_9_val_int_reg) < signed(ap_const_lv18_16C)) else "0";
    icmp_ln4_57_fu_260_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_10D8C)) else "0";
    icmp_ln4_58_fu_276_p2 <= "1" when (signed(tmp_1_fu_266_p4) < signed(ap_const_lv7_1)) else "0";
    icmp_ln4_fu_188_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_2D80)) else "0";
    ...
    select_ln120_fu_414_p3 <= 
        ...
        ap_const_lv2_2;
    tmp_1_fu_266_p4 <= x_7_val_int_reg(17 downto 11);
