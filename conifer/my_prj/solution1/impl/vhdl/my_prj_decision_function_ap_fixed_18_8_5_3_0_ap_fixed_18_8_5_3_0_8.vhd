...
entity my_prj_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_8 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of my_prj_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_8 is 
...
attribute shreg_extract : string;
    ...
    component my_prj_sparsemux_19_4_11_1_0_x IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_19_4_11_1_0_x_U166 : component my_prj_sparsemux_19_4_11_1_0_x
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "0000",
    ...
    icmp_ln4_11_fu_134_p2 <= "1" when (signed(x_4_val_int_reg) < signed(ap_const_lv18_191)) else "0";
    icmp_ln4_12_fu_140_p2 <= "1" when (signed(x_9_val_int_reg) < signed(ap_const_lv18_3FD88)) else "0";
    icmp_ln4_13_fu_146_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_135D3)) else "0";
    icmp_ln4_14_fu_152_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_E50B)) else "0";
    icmp_ln4_15_fu_158_p2 <= "1" when (signed(x_9_val_int_reg) < signed(ap_const_lv18_133)) else "0";
    icmp_ln4_16_fu_164_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_1480)) else "0";
    icmp_ln4_17_fu_170_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_B500)) else "0";
    icmp_ln4_fu_128_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_6DA)) else "0";
