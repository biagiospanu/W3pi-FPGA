...
entity my_prj_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of my_prj_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_1 is 
...
attribute shreg_extract : string;
    ...
    component my_prj_sparsemux_31_4_11_1_0_x IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_31_4_11_1_0_x_U73 : component my_prj_sparsemux_31_4_11_1_0_x
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "0000",
    ...
    icmp_ln4_12_fu_186_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_A80)) else "0";
    icmp_ln4_13_fu_192_p2 <= "1" when (signed(x_7_val_int_reg) < signed(ap_const_lv18_3FA00)) else "0";
    icmp_ln4_14_fu_198_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_1080)) else "0";
    icmp_ln4_15_fu_204_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_1580)) else "0";
    icmp_ln4_16_fu_210_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_880)) else "0";
    icmp_ln4_17_fu_216_p2 <= "1" when (signed(x_4_val_int_reg) < signed(ap_const_lv18_430)) else "0";
    icmp_ln4_18_fu_222_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_B80)) else "0";
    icmp_ln4_19_fu_228_p2 <= "1" when (signed(x_7_val_int_reg) < signed(ap_const_lv18_3FE00)) else "0";
    icmp_ln4_20_fu_234_p2 <= "1" when (signed(x_8_val_int_reg) < signed(ap_const_lv18_130)) else "0";
    icmp_ln4_21_fu_240_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_12E26)) else "0";
    icmp_ln4_22_fu_246_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_1B80)) else "0";
    icmp_ln4_23_fu_252_p2 <= "1" when (signed(x_8_val_int_reg) < signed(ap_const_lv18_1D8)) else "0";
    icmp_ln4_24_fu_258_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_C692)) else "0";
    icmp_ln4_fu_180_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_2580)) else "0";
