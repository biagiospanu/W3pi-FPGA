...
entity my_prj_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of my_prj_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_s is 
...
attribute shreg_extract : string;
    ...
    component my_prj_sparsemux_27_4_11_1_0 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_27_4_11_1_0_U83 : component my_prj_sparsemux_27_4_11_1_0
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "0000",
    ...
    icmp_ln4_10_fu_222_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_E22)) else "0";
    icmp_ln4_11_fu_228_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_1480)) else "0";
    icmp_ln4_1_fu_168_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_6DA)) else "0";
    icmp_ln4_2_fu_174_p2 <= "1" when (signed(x_9_val_int_reg) < signed(ap_const_lv18_3FF3C)) else "0";
    icmp_ln4_3_fu_180_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_1B80)) else "0";
    icmp_ln4_4_fu_186_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_12A72)) else "0";
    icmp_ln4_5_fu_192_p2 <= "1" when (signed(x_8_val_int_reg) < signed(ap_const_lv18_CC)) else "0";
    icmp_ln4_6_fu_198_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_A80)) else "0";
    icmp_ln4_7_fu_204_p2 <= "1" when (signed(x_4_val_int_reg) < signed(ap_const_lv18_8D)) else "0";
    icmp_ln4_8_fu_210_p2 <= "1" when (signed(x_9_val_int_reg) < signed(ap_const_lv18_3FDFA)) else "0";
    icmp_ln4_9_fu_216_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_17CE9)) else "0";
    icmp_ln4_fu_162_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_39F0)) else "0";
