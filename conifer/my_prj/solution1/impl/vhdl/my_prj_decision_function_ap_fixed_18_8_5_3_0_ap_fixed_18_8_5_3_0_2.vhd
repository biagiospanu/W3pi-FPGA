...
entity my_prj_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_2 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of my_prj_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_2 is 
...
attribute shreg_extract : string;
    ...
    component my_prj_sparsemux_31_4_11_1_0 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_31_4_11_1_0_U65 : component my_prj_sparsemux_31_4_11_1_0
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "0000",
    ...
    icmp_ln4_25_fu_176_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_980)) else "0";
    icmp_ln4_26_fu_182_p2 <= "1" when (signed(x_8_val_int_reg) < signed(ap_const_lv18_288)) else "0";
    icmp_ln4_27_fu_188_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_4D1F)) else "0";
    icmp_ln4_28_fu_194_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_2FB7)) else "0";
    icmp_ln4_29_fu_200_p2 <= "1" when (signed(x_9_val_int_reg) < signed(ap_const_lv18_3FE36)) else "0";
    icmp_ln4_30_fu_206_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_12CA3)) else "0";
    icmp_ln4_31_fu_212_p2 <= "1" when (signed(x_8_val_int_reg) < signed(ap_const_lv18_110)) else "0";
    icmp_ln4_32_fu_218_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_A80)) else "0";
    icmp_ln4_33_fu_224_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_13A35)) else "0";
    icmp_ln4_34_fu_230_p2 <= "1" when (signed(x_9_val_int_reg) < signed(ap_const_lv18_3FD66)) else "0";
    icmp_ln4_36_fu_252_p2 <= "1" when (signed(x_9_val_int_reg) < signed(ap_const_lv18_33C)) else "0";
    icmp_ln4_37_fu_258_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_14F2E)) else "0";
    icmp_ln4_67_fu_246_p2 <= "1" when (signed(tmp_fu_236_p4) < signed(ap_const_lv7_1)) else "0";
    icmp_ln4_fu_170_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_4962)) else "0";
    ...
    select_ln120_fu_366_p3 <= 
        ...
        ap_const_lv2_2;
    tmp_fu_236_p4 <= x_7_val_int_reg(17 downto 11);
