...
module my_prj_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_5 (
        ap_clk,
        ap_rst,
        x_0_val,
        x_1_val,
...
assign icmp_ln4_46_fu_194_p2 = (($signed(x_6_val_int_reg) < $signed(18'd12416)) ? 1'b1 : 1'b0);

assign icmp_ln4_47_fu_200_p2 = (($signed(x_0_val_int_reg) < $signed(18'd9856)) ? 1'b1 : 1'b0);

assign icmp_ln4_48_fu_206_p2 = (($signed(x_0_val_int_reg) < $signed(18'd2688)) ? 1'b1 : 1'b0);

assign icmp_ln4_49_fu_212_p2 = (($signed(x_0_val_int_reg) < $signed(18'd6528)) ? 1'b1 : 1'b0);

assign icmp_ln4_50_fu_218_p2 = (($signed(x_7_val_int_reg) < $signed(18'd1536)) ? 1'b1 : 1'b0);

assign icmp_ln4_51_fu_224_p2 = (($signed(x_2_val_int_reg) < $signed(18'd4704)) ? 1'b1 : 1'b0);

assign icmp_ln4_52_fu_230_p2 = (($signed(x_1_val_int_reg) < $signed(18'd7296)) ? 1'b1 : 1'b0);

assign icmp_ln4_53_fu_236_p2 = (($signed(x_6_val_int_reg) < $signed(18'd9600)) ? 1'b1 : 1'b0);

assign icmp_ln4_54_fu_242_p2 = (($signed(x_6_val_int_reg) < $signed(18'd49152)) ? 1'b1 : 1'b0);

assign icmp_ln4_55_fu_248_p2 = (($signed(x_8_val_int_reg) < $signed(18'd452)) ? 1'b1 : 1'b0);

assign icmp_ln4_56_fu_254_p2 = (($signed(x_9_val_int_reg) < $signed(18'd364)) ? 1'b1 : 1'b0);

assign icmp_ln4_57_fu_260_p2 = (($signed(x_3_val_int_reg) < $signed(18'd69004)) ? 1'b1 : 1'b0);

assign icmp_ln4_58_fu_276_p2 = (($signed(tmp_1_fu_266_p4) < $signed(7'd1)) ? 1'b1 : 1'b0);

assign icmp_ln4_fu_188_p2 = (($signed(x_1_val_int_reg) < $signed(18'd11648)) ? 1'b1 : 1'b0);
...
assign tmp_1_fu_266_p4 = {{x_7_val_int_reg[17:11]}};
...
endmodule //my_prj_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_5
