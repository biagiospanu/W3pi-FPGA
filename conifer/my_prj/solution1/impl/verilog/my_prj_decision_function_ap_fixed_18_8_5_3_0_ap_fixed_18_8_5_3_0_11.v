...
module my_prj_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_11 (
        ap_clk,
        ap_rst,
        x_1_val,
        x_2_val,
...
assign icmp_ln4_137_fu_136_p2 = (($signed(x_2_val_int_reg) < $signed(18'd1754)) ? 1'b1 : 1'b0);

assign icmp_ln4_138_fu_142_p2 = (($signed(x_8_val_int_reg) < $signed(18'd49)) ? 1'b1 : 1'b0);

assign icmp_ln4_139_fu_148_p2 = (($signed(x_6_val_int_reg) < $signed(18'd32128)) ? 1'b1 : 1'b0);

assign icmp_ln4_140_fu_154_p2 = (($signed(x_1_val_int_reg) < $signed(18'd13696)) ? 1'b1 : 1'b0);

assign icmp_ln4_141_fu_160_p2 = (($signed(x_5_val_int_reg) < $signed(18'd2488)) ? 1'b1 : 1'b0);

assign icmp_ln4_142_fu_166_p2 = (($signed(x_5_val_int_reg) < $signed(18'd2320)) ? 1'b1 : 1'b0);

assign icmp_ln4_143_fu_172_p2 = (($signed(x_1_val_int_reg) < $signed(18'd19072)) ? 1'b1 : 1'b0);

assign icmp_ln4_fu_130_p2 = (($signed(x_7_val_int_reg) < $signed(18'd1536)) ? 1'b1 : 1'b0);
...
endmodule //my_prj_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_11
