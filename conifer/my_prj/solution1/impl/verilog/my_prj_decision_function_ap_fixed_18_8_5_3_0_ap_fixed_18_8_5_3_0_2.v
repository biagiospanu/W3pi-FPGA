...
module my_prj_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_2 (
        ap_clk,
        ap_rst,
        x_0_val,
        x_2_val,
...
assign icmp_ln4_25_fu_176_p2 = (($signed(x_0_val_int_reg) < $signed(18'd2432)) ? 1'b1 : 1'b0);

assign icmp_ln4_26_fu_182_p2 = (($signed(x_8_val_int_reg) < $signed(18'd648)) ? 1'b1 : 1'b0);

assign icmp_ln4_27_fu_188_p2 = (($signed(x_3_val_int_reg) < $signed(18'd19743)) ? 1'b1 : 1'b0);

assign icmp_ln4_28_fu_194_p2 = (($signed(x_2_val_int_reg) < $signed(18'd12215)) ? 1'b1 : 1'b0);

assign icmp_ln4_29_fu_200_p2 = (($signed(x_9_val_int_reg) < $signed(18'd261686)) ? 1'b1 : 1'b0);

assign icmp_ln4_30_fu_206_p2 = (($signed(x_3_val_int_reg) < $signed(18'd76963)) ? 1'b1 : 1'b0);

assign icmp_ln4_31_fu_212_p2 = (($signed(x_8_val_int_reg) < $signed(18'd272)) ? 1'b1 : 1'b0);

assign icmp_ln4_32_fu_218_p2 = (($signed(x_0_val_int_reg) < $signed(18'd2688)) ? 1'b1 : 1'b0);

assign icmp_ln4_33_fu_224_p2 = (($signed(x_3_val_int_reg) < $signed(18'd80437)) ? 1'b1 : 1'b0);

assign icmp_ln4_34_fu_230_p2 = (($signed(x_9_val_int_reg) < $signed(18'd261478)) ? 1'b1 : 1'b0);

assign icmp_ln4_36_fu_252_p2 = (($signed(x_9_val_int_reg) < $signed(18'd828)) ? 1'b1 : 1'b0);

assign icmp_ln4_37_fu_258_p2 = (($signed(x_3_val_int_reg) < $signed(18'd85806)) ? 1'b1 : 1'b0);

assign icmp_ln4_67_fu_246_p2 = (($signed(tmp_fu_236_p4) < $signed(7'd1)) ? 1'b1 : 1'b0);

assign icmp_ln4_fu_170_p2 = (($signed(x_2_val_int_reg) < $signed(18'd18786)) ? 1'b1 : 1'b0);
...
assign tmp_fu_236_p4 = {{x_7_val_int_reg[17:11]}};
...
endmodule //my_prj_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_2
