...
entity my_prj_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_14 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of my_prj_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_14 is 
...
attribute shreg_extract : string;
    ...
    component my_prj_sparsemux_29_4_11_1_0 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_29_4_11_1_0_U112 : component my_prj_sparsemux_29_4_11_1_0
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "0000",
    ...
    icmp_ln4_118_fu_172_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_B80)) else "0";
    icmp_ln4_119_fu_178_p2 <= "1" when (signed(x_7_val_int_reg) < signed(ap_const_lv18_600)) else "0";
    icmp_ln4_120_fu_184_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_1280)) else "0";
    icmp_ln4_121_fu_190_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_6DA)) else "0";
    icmp_ln4_122_fu_196_p2 <= "1" when (signed(x_7_val_int_reg) < signed(ap_const_lv18_3FA00)) else "0";
    icmp_ln4_123_fu_202_p2 <= "1" when (signed(x_8_val_int_reg) < signed(ap_const_lv18_31)) else "0";
    icmp_ln4_124_fu_208_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_1280)) else "0";
    icmp_ln4_125_fu_214_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_C61)) else "0";
    icmp_ln4_126_fu_220_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_1F80)) else "0";
    icmp_ln4_127_fu_226_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_4980)) else "0";
    icmp_ln4_128_fu_232_p2 <= "1" when (signed(x_8_val_int_reg) < signed(ap_const_lv18_4CC)) else "0";
    icmp_ln4_129_fu_238_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_CF2E)) else "0";
    icmp_ln4_fu_166_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_2FB7)) else "0";
