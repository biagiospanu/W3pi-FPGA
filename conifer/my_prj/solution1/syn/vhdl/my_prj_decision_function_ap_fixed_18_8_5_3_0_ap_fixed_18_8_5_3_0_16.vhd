...
entity my_prj_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_16 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of my_prj_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_16 is 
...
attribute shreg_extract : string;
    ...
    component my_prj_sparsemux_25_4_11_1_0 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_25_4_11_1_0_U92 : component my_prj_sparsemux_25_4_11_1_0
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "0000",
    ...
    icmp_ln4_100_fu_198_p2 <= "1" when (signed(x_4_val_int_reg) < signed(ap_const_lv18_D47)) else "0";
    icmp_ln4_101_fu_204_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_131CC)) else "0";
    icmp_ln4_102_fu_210_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_C47)) else "0";
    icmp_ln4_103_fu_216_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_EEFA)) else "0";
    icmp_ln4_94_fu_162_p2 <= "1" when (signed(x_7_val_int_reg) < signed(ap_const_lv18_3FA00)) else "0";
    icmp_ln4_95_fu_168_p2 <= "1" when (signed(x_8_val_int_reg) < signed(ap_const_lv18_31)) else "0";
    icmp_ln4_96_fu_174_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_880)) else "0";
    icmp_ln4_97_fu_180_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_196EE)) else "0";
    icmp_ln4_98_fu_186_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_10B53)) else "0";
    icmp_ln4_99_fu_192_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_7F80)) else "0";
    icmp_ln4_fu_156_p2 <= "1" when (signed(x_7_val_int_reg) < signed(ap_const_lv18_600)) else "0";
