...
entity my_prj_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_13 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of my_prj_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_13 is 
...
attribute shreg_extract : string;
    ...
    component my_prj_sparsemux_33_4_11_1_0_x3 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_33_4_11_1_0_x3_U121 : component my_prj_sparsemux_33_4_11_1_0_x3
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "0000",
    ...
    icmp_ln4_130_fu_192_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_11903)) else "0";
    icmp_ln4_131_fu_198_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_15A2A)) else "0";
    icmp_ln4_132_fu_204_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_8C80)) else "0";
    icmp_ln4_133_fu_210_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_CDD)) else "0";
    icmp_ln4_134_fu_216_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3480)) else "0";
    icmp_ln4_135_fu_222_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_15B67)) else "0";
    icmp_ln4_136_fu_228_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_4E80)) else "0";
    icmp_ln4_137_fu_234_p2 <= "1" when (signed(x_9_val_int_reg) < signed(ap_const_lv18_3FC3C)) else "0";
    icmp_ln4_138_fu_240_p2 <= "1" when (signed(x_8_val_int_reg) < signed(ap_const_lv18_18)) else "0";
    icmp_ln4_139_fu_246_p2 <= "1" when (signed(x_9_val_int_reg) < signed(ap_const_lv18_3FAE8)) else "0";
    icmp_ln4_140_fu_252_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_1B80)) else "0";
    icmp_ln4_141_fu_258_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_11F76)) else "0";
    icmp_ln4_142_fu_264_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_2980)) else "0";
    icmp_ln4_143_fu_270_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_1ACEF)) else "0";
    icmp_ln4_fu_186_p2 <= "1" when (signed(x_9_val_int_reg) < signed(ap_const_lv18_3FD94)) else "0";
