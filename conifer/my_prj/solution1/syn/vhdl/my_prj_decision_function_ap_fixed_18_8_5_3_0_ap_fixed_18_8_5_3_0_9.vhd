...
entity my_prj_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_9 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of my_prj_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_9 is 
...
attribute shreg_extract : string;
    ...
    component my_prj_sparsemux_25_4_11_1_0_x IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_25_4_11_1_0_x_U157 : component my_prj_sparsemux_25_4_11_1_0_x
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "0000",
    ...
    icmp_ln4_10_fu_214_p2 <= "1" when (signed(x_4_val_int_reg) < signed(ap_const_lv18_F31)) else "0";
    icmp_ln4_1_fu_160_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_4980)) else "0";
    icmp_ln4_2_fu_166_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_2280)) else "0";
    icmp_ln4_3_fu_172_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_5880)) else "0";
    icmp_ln4_4_fu_178_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_7F0E)) else "0";
    icmp_ln4_5_fu_184_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_3F80)) else "0";
    icmp_ln4_6_fu_190_p2 <= "1" when (signed(x_9_val_int_reg) < signed(ap_const_lv18_3FE9A)) else "0";
    icmp_ln4_7_fu_196_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_1A80)) else "0";
    icmp_ln4_8_fu_202_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_2B80)) else "0";
    icmp_ln4_9_fu_208_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3280)) else "0";
    icmp_ln4_fu_154_p2 <= "1" when (signed(x_7_val_int_reg) < signed(ap_const_lv18_3FA00)) else "0";
