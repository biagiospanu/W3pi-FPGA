...
module my_prj_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_14 (
        ap_clk,
        ap_rst,
        x_0_val,
        x_1_val,
...
assign icmp_ln4_118_fu_172_p2 = (($signed(x_0_val_int_reg) < $signed(18'd2944)) ? 1'b1 : 1'b0);

assign icmp_ln4_119_fu_178_p2 = (($signed(x_7_val_int_reg) < $signed(18'd1536)) ? 1'b1 : 1'b0);

assign icmp_ln4_120_fu_184_p2 = (($signed(x_1_val_int_reg) < $signed(18'd4736)) ? 1'b1 : 1'b0);

assign icmp_ln4_121_fu_190_p2 = (($signed(x_2_val_int_reg) < $signed(18'd1754)) ? 1'b1 : 1'b0);

assign icmp_ln4_122_fu_196_p2 = (($signed(x_7_val_int_reg) < $signed(18'd260608)) ? 1'b1 : 1'b0);

assign icmp_ln4_123_fu_202_p2 = (($signed(x_8_val_int_reg) < $signed(18'd49)) ? 1'b1 : 1'b0);

assign icmp_ln4_124_fu_208_p2 = (($signed(x_6_val_int_reg) < $signed(18'd4736)) ? 1'b1 : 1'b0);

assign icmp_ln4_125_fu_214_p2 = (($signed(x_5_val_int_reg) < $signed(18'd3169)) ? 1'b1 : 1'b0);

assign icmp_ln4_126_fu_220_p2 = (($signed(x_0_val_int_reg) < $signed(18'd8064)) ? 1'b1 : 1'b0);

assign icmp_ln4_127_fu_226_p2 = (($signed(x_1_val_int_reg) < $signed(18'd18816)) ? 1'b1 : 1'b0);

assign icmp_ln4_128_fu_232_p2 = (($signed(x_8_val_int_reg) < $signed(18'd1228)) ? 1'b1 : 1'b0);

assign icmp_ln4_129_fu_238_p2 = (($signed(x_2_val_int_reg) < $signed(18'd53038)) ? 1'b1 : 1'b0);

assign icmp_ln4_fu_166_p2 = (($signed(x_2_val_int_reg) < $signed(18'd12215)) ? 1'b1 : 1'b0);
...
endmodule //my_prj_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_14
