...
module my_prj_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_6 (
        ap_clk,
        ap_rst,
        x_0_val,
        x_1_val,
...
assign icmp_ln4_32_fu_178_p2 = (($signed(x_1_val_int_reg) < $signed(18'd8832)) ? 1'b1 : 1'b0);

assign icmp_ln4_33_fu_184_p2 = (($signed(x_0_val_int_reg) < $signed(18'd3968)) ? 1'b1 : 1'b0);

assign icmp_ln4_34_fu_190_p2 = (($signed(x_6_val_int_reg) < $signed(18'd50688)) ? 1'b1 : 1'b0);

assign icmp_ln4_35_fu_196_p2 = (($signed(x_4_val_int_reg) < $signed(18'd396)) ? 1'b1 : 1'b0);

assign icmp_ln4_36_fu_202_p2 = (($signed(x_2_val_int_reg) < $signed(18'd62777)) ? 1'b1 : 1'b0);

assign icmp_ln4_37_fu_208_p2 = (($signed(x_4_val_int_reg) < $signed(18'd430)) ? 1'b1 : 1'b0);

assign icmp_ln4_38_fu_214_p2 = (($signed(x_6_val_int_reg) < $signed(18'd10624)) ? 1'b1 : 1'b0);

assign icmp_ln4_39_fu_220_p2 = (($signed(x_8_val_int_reg) < $signed(18'd354)) ? 1'b1 : 1'b0);

assign icmp_ln4_40_fu_226_p2 = (($signed(x_0_val_int_reg) < $signed(18'd4736)) ? 1'b1 : 1'b0);

assign icmp_ln4_41_fu_232_p2 = (($signed(x_2_val_int_reg) < $signed(18'd66630)) ? 1'b1 : 1'b0);

assign icmp_ln4_42_fu_238_p2 = (($signed(x_6_val_int_reg) < $signed(18'd61440)) ? 1'b1 : 1'b0);

assign icmp_ln4_43_fu_244_p2 = (($signed(x_8_val_int_reg) < $signed(18'd768)) ? 1'b1 : 1'b0);

assign icmp_ln4_44_fu_250_p2 = (($signed(x_8_val_int_reg) < $signed(18'd708)) ? 1'b1 : 1'b0);

assign icmp_ln4_45_fu_256_p2 = (($signed(x_0_val_int_reg) < $signed(18'd10880)) ? 1'b1 : 1'b0);

assign icmp_ln4_fu_172_p2 = (($signed(x_1_val_int_reg) < $signed(18'd14208)) ? 1'b1 : 1'b0);
...
endmodule //my_prj_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_6
