...
module my_prj_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_4 (
        ap_clk,
        ap_rst,
        x_0_val,
        x_1_val,
...
assign icmp_ln4_52_fu_184_p2 = (($signed(x_1_val_int_reg) < $signed(18'd7296)) ? 1'b1 : 1'b0);

assign icmp_ln4_53_fu_190_p2 = (($signed(x_9_val_int_reg) < $signed(18'd261524)) ? 1'b1 : 1'b0);

assign icmp_ln4_54_fu_196_p2 = (($signed(x_0_val_int_reg) < $signed(18'd6272)) ? 1'b1 : 1'b0);

assign icmp_ln4_55_fu_202_p2 = (($signed(x_5_val_int_reg) < $signed(18'd2554)) ? 1'b1 : 1'b0);

assign icmp_ln4_56_fu_208_p2 = (($signed(x_6_val_int_reg) < $signed(18'd56832)) ? 1'b1 : 1'b0);

assign icmp_ln4_57_fu_214_p2 = (($signed(x_7_val_int_reg) < $signed(18'd260608)) ? 1'b1 : 1'b0);

assign icmp_ln4_58_fu_220_p2 = (($signed(x_6_val_int_reg) < $signed(18'd14208)) ? 1'b1 : 1'b0);

assign icmp_ln4_59_fu_226_p2 = (($signed(x_6_val_int_reg) < $signed(18'd11648)) ? 1'b1 : 1'b0);

assign icmp_ln4_60_fu_232_p2 = (($signed(x_1_val_int_reg) < $signed(18'd29312)) ? 1'b1 : 1'b0);

assign icmp_ln4_61_fu_238_p2 = (($signed(x_9_val_int_reg) < $signed(18'd261740)) ? 1'b1 : 1'b0);

assign icmp_ln4_62_fu_244_p2 = (($signed(x_0_val_int_reg) < $signed(18'd12416)) ? 1'b1 : 1'b0);

assign icmp_ln4_63_fu_250_p2 = (($signed(x_3_val_int_reg) < $signed(18'd93003)) ? 1'b1 : 1'b0);

assign icmp_ln4_64_fu_256_p2 = (($signed(x_0_val_int_reg) < $signed(18'd2176)) ? 1'b1 : 1'b0);

assign icmp_ln4_65_fu_262_p2 = (($signed(x_3_val_int_reg) < $signed(18'd91010)) ? 1'b1 : 1'b0);

assign icmp_ln4_fu_178_p2 = (($signed(x_3_val_int_reg) < $signed(18'd57882)) ? 1'b1 : 1'b0);
...
endmodule //my_prj_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_4
