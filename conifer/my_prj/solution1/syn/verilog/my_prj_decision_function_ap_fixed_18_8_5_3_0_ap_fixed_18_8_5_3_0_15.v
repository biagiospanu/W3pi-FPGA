...
module my_prj_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_15 (
        ap_clk,
        ap_rst,
        x_0_val,
        x_1_val,
...
assign icmp_ln4_104_fu_200_p2 = (($signed(x_2_val_int_reg) < $signed(18'd56050)) ? 1'b1 : 1'b0);

assign icmp_ln4_105_fu_206_p2 = (($signed(x_4_val_int_reg) < $signed(18'd232)) ? 1'b1 : 1'b0);

assign icmp_ln4_106_fu_212_p2 = (($signed(x_8_val_int_reg) < $signed(18'd620)) ? 1'b1 : 1'b0);

assign icmp_ln4_107_fu_218_p2 = (($signed(x_6_val_int_reg) < $signed(18'd28288)) ? 1'b1 : 1'b0);

assign icmp_ln4_108_fu_224_p2 = (($signed(x_8_val_int_reg) < $signed(18'd307)) ? 1'b1 : 1'b0);

assign icmp_ln4_109_fu_230_p2 = (($signed(x_3_val_int_reg) < $signed(18'd85740)) ? 1'b1 : 1'b0);

assign icmp_ln4_110_fu_236_p2 = (($signed(x_6_val_int_reg) < $signed(18'd22144)) ? 1'b1 : 1'b0);

assign icmp_ln4_111_fu_242_p2 = (($signed(x_5_val_int_reg) < $signed(18'd5115)) ? 1'b1 : 1'b0);

assign icmp_ln4_112_fu_248_p2 = (($signed(x_1_val_int_reg) < $signed(18'd8832)) ? 1'b1 : 1'b0);

assign icmp_ln4_113_fu_254_p2 = (($signed(x_9_val_int_reg) < $signed(18'd262092)) ? 1'b1 : 1'b0);

assign icmp_ln4_114_fu_260_p2 = (($signed(x_3_val_int_reg) < $signed(18'd42881)) ? 1'b1 : 1'b0);

assign icmp_ln4_115_fu_266_p2 = (($signed(x_0_val_int_reg) < $signed(18'd4992)) ? 1'b1 : 1'b0);

assign icmp_ln4_116_fu_272_p2 = (($signed(x_1_val_int_reg) < $signed(18'd23424)) ? 1'b1 : 1'b0);

assign icmp_ln4_117_fu_278_p2 = (($signed(x_2_val_int_reg) < $signed(18'd69007)) ? 1'b1 : 1'b0);

assign icmp_ln4_fu_194_p2 = (($signed(x_0_val_int_reg) < $signed(18'd4224)) ? 1'b1 : 1'b0);
...
endmodule //my_prj_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_15
