...
module my_prj_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_12 (
        ap_clk,
        ap_rst,
        x_2_val,
        x_3_val,
...
assign icmp_ln4_144_fu_170_p2 = (($signed(x_9_val_int_reg) < $signed(18'd261948)) ? 1'b1 : 1'b0);

assign icmp_ln4_145_fu_176_p2 = (($signed(x_2_val_int_reg) < $signed(18'd73236)) ? 1'b1 : 1'b0);

assign icmp_ln4_146_fu_182_p2 = (($signed(x_3_val_int_reg) < $signed(18'd52621)) ? 1'b1 : 1'b0);

assign icmp_ln4_147_fu_188_p2 = (($signed(x_9_val_int_reg) < $signed(18'd870)) ? 1'b1 : 1'b0);

assign icmp_ln4_148_fu_194_p2 = (($signed(x_6_val_int_reg) < $signed(18'd38016)) ? 1'b1 : 1'b0);

assign icmp_ln4_149_fu_200_p2 = (($signed(x_3_val_int_reg) < $signed(18'd88783)) ? 1'b1 : 1'b0);

assign icmp_ln4_150_fu_206_p2 = (($signed(x_6_val_int_reg) < $signed(18'd15488)) ? 1'b1 : 1'b0);

assign icmp_ln4_151_fu_212_p2 = (($signed(x_4_val_int_reg) < $signed(18'd395)) ? 1'b1 : 1'b0);

assign icmp_ln4_152_fu_218_p2 = (($signed(x_5_val_int_reg) < $signed(18'd4677)) ? 1'b1 : 1'b0);

assign icmp_ln4_153_fu_224_p2 = (($signed(x_3_val_int_reg) < $signed(18'd81020)) ? 1'b1 : 1'b0);

assign icmp_ln4_154_fu_230_p2 = (($signed(x_6_val_int_reg) < $signed(18'd30336)) ? 1'b1 : 1'b0);

assign icmp_ln4_155_fu_236_p2 = (($signed(x_6_val_int_reg) < $signed(18'd49920)) ? 1'b1 : 1'b0);

assign icmp_ln4_156_fu_242_p2 = (($signed(x_9_val_int_reg) < $signed(18'd262084)) ? 1'b1 : 1'b0);

assign icmp_ln4_fu_164_p2 = (($signed(x_4_val_int_reg) < $signed(18'd4006)) ? 1'b1 : 1'b0);
...
endmodule //my_prj_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_12
