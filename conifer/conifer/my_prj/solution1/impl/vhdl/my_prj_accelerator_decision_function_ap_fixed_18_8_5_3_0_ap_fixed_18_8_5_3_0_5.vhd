...
entity my_prj_accelerator_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_5 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of my_prj_accelerator_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_5 is 
...
attribute shreg_extract : string;
    ...
    signal tmp_8_fu_266_p4 : STD_LOGIC_VECTOR (6 downto 0);
    ...
    component my_prj_accelerator_sparsemux_31_4_12_1_0 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_31_4_12_1_0_U64 : component my_prj_accelerator_sparsemux_31_4_12_1_0
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "0000",
    ...
    icmp_ln4_58_fu_276_p2 <= "1" when (signed(tmp_8_fu_266_p4) < signed(ap_const_lv7_1)) else "0";
    ...
    select_ln120_fu_414_p3 <= 
        ...
        ap_const_lv2_2;
    tmp_8_fu_266_p4 <= p_read6_int_reg(17 downto 11);
