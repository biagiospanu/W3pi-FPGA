...
entity conifer_xgboost_moons_accelerator_shl_18ns_11ns_18_2_1 is
    generic (
      ID         : INTEGER := 1;                            --core ID,       unused in RTL
      din0_WIDTH : INTEGER := 18;                 --data bitwidth
      din1_WIDTH : INTEGER := 18;                 --shift control bitwidth
      dout_WIDTH : INTEGER := 18;                 --output bitwidth
...
end entity conifer_xgboost_moons_accelerator_shl_18ns_11ns_18_2_1;
architecture rtl of conifer_xgboost_moons_accelerator_shl_18ns_11ns_18_2_1 is
