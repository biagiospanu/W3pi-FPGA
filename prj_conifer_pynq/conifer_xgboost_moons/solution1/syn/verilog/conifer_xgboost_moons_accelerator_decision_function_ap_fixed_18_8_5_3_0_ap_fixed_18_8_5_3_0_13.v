...
module conifer_xgboost_moons_accelerator_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_13 (
        ap_clk,
        ap_rst,
        p_read1,
        p_read2,
...
assign icmp_ln4_130_fu_192_p2 = (($signed(p_read3_int_reg) < $signed(18'd71939)) ? 1'b1 : 1'b0);

assign icmp_ln4_131_fu_198_p2 = (($signed(p_read4_int_reg) < $signed(18'd88618)) ? 1'b1 : 1'b0);

assign icmp_ln4_132_fu_204_p2 = (($signed(p_read6_int_reg) < $signed(18'd35968)) ? 1'b1 : 1'b0);

assign icmp_ln4_133_fu_210_p2 = (($signed(p_read5_int_reg) < $signed(18'd3293)) ? 1'b1 : 1'b0);

assign icmp_ln4_134_fu_216_p2 = (($signed(p_read1_int_reg) < $signed(18'd13440)) ? 1'b1 : 1'b0);

assign icmp_ln4_135_fu_222_p2 = (($signed(p_read3_int_reg) < $signed(18'd88935)) ? 1'b1 : 1'b0);

assign icmp_ln4_136_fu_228_p2 = (($signed(p_read2_int_reg) < $signed(18'd20096)) ? 1'b1 : 1'b0);

assign icmp_ln4_137_fu_234_p2 = (($signed(p_read8_int_reg) < $signed(18'd261180)) ? 1'b1 : 1'b0);

assign icmp_ln4_138_fu_240_p2 = (($signed(p_read7_int_reg) < $signed(18'd24)) ? 1'b1 : 1'b0);

assign icmp_ln4_139_fu_246_p2 = (($signed(p_read8_int_reg) < $signed(18'd260840)) ? 1'b1 : 1'b0);

assign icmp_ln4_140_fu_252_p2 = (($signed(p_read6_int_reg) < $signed(18'd7040)) ? 1'b1 : 1'b0);

assign icmp_ln4_141_fu_258_p2 = (($signed(p_read4_int_reg) < $signed(18'd73590)) ? 1'b1 : 1'b0);

assign icmp_ln4_142_fu_264_p2 = (($signed(p_read1_int_reg) < $signed(18'd10624)) ? 1'b1 : 1'b0);

assign icmp_ln4_143_fu_270_p2 = (($signed(p_read4_int_reg) < $signed(18'd109807)) ? 1'b1 : 1'b0);

assign icmp_ln4_fu_186_p2 = (($signed(p_read8_int_reg) < $signed(18'd261524)) ? 1'b1 : 1'b0);
...
endmodule //conifer_xgboost_moons_accelerator_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_13
