...
module conifer_xgboost_moons_accelerator_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_s (
        ap_clk,
        ap_rst,
        p_read1,
        p_read2,
...
assign icmp_ln4_10_fu_222_p2 = (($signed(p_read5_int_reg) < $signed(18'd3618)) ? 1'b1 : 1'b0);

assign icmp_ln4_11_fu_228_p2 = (($signed(p_read1_int_reg) < $signed(18'd5248)) ? 1'b1 : 1'b0);

assign icmp_ln4_1_fu_168_p2 = (($signed(p_read2_int_reg) < $signed(18'd1754)) ? 1'b1 : 1'b0);

assign icmp_ln4_2_fu_174_p2 = (($signed(p_read7_int_reg) < $signed(18'd261948)) ? 1'b1 : 1'b0);

assign icmp_ln4_3_fu_180_p2 = (($signed(p_read1_int_reg) < $signed(18'd7040)) ? 1'b1 : 1'b0);

assign icmp_ln4_4_fu_186_p2 = (($signed(p_read3_int_reg) < $signed(18'd76402)) ? 1'b1 : 1'b0);

assign icmp_ln4_5_fu_192_p2 = (($signed(p_read6_int_reg) < $signed(18'd204)) ? 1'b1 : 1'b0);

assign icmp_ln4_6_fu_198_p2 = (($signed(p_read1_int_reg) < $signed(18'd2688)) ? 1'b1 : 1'b0);

assign icmp_ln4_7_fu_204_p2 = (($signed(p_read4_int_reg) < $signed(18'd141)) ? 1'b1 : 1'b0);

assign icmp_ln4_8_fu_210_p2 = (($signed(p_read7_int_reg) < $signed(18'd261626)) ? 1'b1 : 1'b0);

assign icmp_ln4_9_fu_216_p2 = (($signed(p_read3_int_reg) < $signed(18'd97513)) ? 1'b1 : 1'b0);

assign icmp_ln4_fu_162_p2 = (($signed(p_read2_int_reg) < $signed(18'd14832)) ? 1'b1 : 1'b0);
...
endmodule //conifer_xgboost_moons_accelerator_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_s
