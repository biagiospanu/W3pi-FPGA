...
set name conifer_xgboost_moons_accelerator_fpext_32ns_64_4_no_dsp_1
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler conifer_xgboost_moons_accelerator_ashr_54ns_11ns_54_7_1 BINDTYPE {op} TYPE {ashr} IMPL {auto_pipe} LATENCY 6
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler conifer_xgboost_moons_accelerator_shl_18ns_11ns_18_2_1 BINDTYPE {op} TYPE {shl} IMPL {auto_pipe} LATENCY 1
}
