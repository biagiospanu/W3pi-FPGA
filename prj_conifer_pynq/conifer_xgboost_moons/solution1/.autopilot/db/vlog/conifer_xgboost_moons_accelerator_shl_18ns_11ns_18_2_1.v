...
module conifer_xgboost_moons_accelerator_shl_18ns_11ns_18_2_1
#(parameter
    ID         = 1,                       // core ID, unused in RTL
    din0_WIDTH = 18,            // data bitwidth
    din1_WIDTH = 18,            // shift control bitwidth
    dout_WIDTH = 18,            // output bitwidth
