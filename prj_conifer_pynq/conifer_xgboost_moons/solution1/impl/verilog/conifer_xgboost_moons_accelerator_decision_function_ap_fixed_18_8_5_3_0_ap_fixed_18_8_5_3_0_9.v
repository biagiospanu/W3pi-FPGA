...
module conifer_xgboost_moons_accelerator_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_9 (
        ap_clk,
        ap_rst,
        p_read1,
        p_read2,
...
assign icmp_ln4_10_fu_214_p2 = (($signed(p_read4_int_reg) < $signed(18'd3889)) ? 1'b1 : 1'b0);

assign icmp_ln4_1_fu_160_p2 = (($signed(p_read2_int_reg) < $signed(18'd18816)) ? 1'b1 : 1'b0);

assign icmp_ln4_2_fu_166_p2 = (($signed(p_read1_int_reg) < $signed(18'd8832)) ? 1'b1 : 1'b0);

assign icmp_ln4_3_fu_172_p2 = (($signed(p_read2_int_reg) < $signed(18'd22656)) ? 1'b1 : 1'b0);

assign icmp_ln4_4_fu_178_p2 = (($signed(p_read3_int_reg) < $signed(18'd32526)) ? 1'b1 : 1'b0);

assign icmp_ln4_5_fu_184_p2 = (($signed(p_read2_int_reg) < $signed(18'd16256)) ? 1'b1 : 1'b0);

assign icmp_ln4_6_fu_190_p2 = (($signed(p_read7_int_reg) < $signed(18'd261786)) ? 1'b1 : 1'b0);

assign icmp_ln4_7_fu_196_p2 = (($signed(p_read5_int_reg) < $signed(18'd6784)) ? 1'b1 : 1'b0);

assign icmp_ln4_8_fu_202_p2 = (($signed(p_read5_int_reg) < $signed(18'd11136)) ? 1'b1 : 1'b0);

assign icmp_ln4_9_fu_208_p2 = (($signed(p_read1_int_reg) < $signed(18'd12928)) ? 1'b1 : 1'b0);

assign icmp_ln4_fu_154_p2 = (($signed(p_read6_int_reg) < $signed(18'd260608)) ? 1'b1 : 1'b0);
...
endmodule //conifer_xgboost_moons_accelerator_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_9
