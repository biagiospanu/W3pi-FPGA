...
entity conifer_xgboost_moons_accelerator_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_3 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of conifer_xgboost_moons_accelerator_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_3 is 
...
attribute shreg_extract : string;
    ...
    component conifer_xgboost_moons_accelerator_sparsemux_33_4_11_1_0_x1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_33_4_11_1_0_x1_U83 : component conifer_xgboost_moons_accelerator_sparsemux_33_4_11_1_0_x1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "0000",
    ...
    icmp_ln4_38_fu_190_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_2980)) else "0";
    icmp_ln4_39_fu_196_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_286)) else "0";
    icmp_ln4_40_fu_202_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_A80)) else "0";
    icmp_ln4_41_fu_208_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_1DB)) else "0";
    icmp_ln4_42_fu_214_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_1280)) else "0";
    icmp_ln4_43_fu_220_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_D664)) else "0";
    icmp_ln4_44_fu_226_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_1D80)) else "0";
    icmp_ln4_45_fu_232_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_1980)) else "0";
    icmp_ln4_46_fu_238_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_1580)) else "0";
    icmp_ln4_47_fu_244_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_2B80)) else "0";
    icmp_ln4_48_fu_250_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_1318E)) else "0";
    icmp_ln4_50_fu_272_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_6880)) else "0";
    icmp_ln4_51_fu_278_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_2180)) else "0";
    icmp_ln4_66_fu_266_p2 <= "1" when (signed(tmp_fu_256_p4) < signed(ap_const_lv7_1)) else "0";
    icmp_ln4_fu_184_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_2280)) else "0";
    ...
    select_ln120_fu_408_p3 <= 
        ...
        ap_const_lv2_2;
    tmp_fu_256_p4 <= p_read7_int_reg(17 downto 11);
