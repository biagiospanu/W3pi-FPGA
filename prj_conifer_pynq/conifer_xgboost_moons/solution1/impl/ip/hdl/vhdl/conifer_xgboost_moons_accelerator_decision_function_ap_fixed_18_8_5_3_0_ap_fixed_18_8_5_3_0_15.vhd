...
entity conifer_xgboost_moons_accelerator_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_15 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of conifer_xgboost_moons_accelerator_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_15 is 
...
attribute shreg_extract : string;
    ...
    component conifer_xgboost_moons_accelerator_sparsemux_33_4_11_1_0_x2 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_33_4_11_1_0_x2_U128 : component conifer_xgboost_moons_accelerator_sparsemux_33_4_11_1_0_x2
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "0000",
    ...
    icmp_ln4_104_fu_200_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_DAF2)) else "0";
    icmp_ln4_105_fu_206_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_E8)) else "0";
    icmp_ln4_106_fu_212_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_26C)) else "0";
    icmp_ln4_107_fu_218_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_6E80)) else "0";
    icmp_ln4_108_fu_224_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_133)) else "0";
    icmp_ln4_109_fu_230_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_14EEC)) else "0";
    icmp_ln4_110_fu_236_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_5680)) else "0";
    icmp_ln4_111_fu_242_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_13FB)) else "0";
    icmp_ln4_112_fu_248_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_2280)) else "0";
    icmp_ln4_113_fu_254_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3FFCC)) else "0";
    icmp_ln4_114_fu_260_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_A781)) else "0";
    icmp_ln4_115_fu_266_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_1380)) else "0";
    icmp_ln4_116_fu_272_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_5B80)) else "0";
    icmp_ln4_117_fu_278_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_10D8F)) else "0";
    icmp_ln4_fu_194_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_1080)) else "0";
