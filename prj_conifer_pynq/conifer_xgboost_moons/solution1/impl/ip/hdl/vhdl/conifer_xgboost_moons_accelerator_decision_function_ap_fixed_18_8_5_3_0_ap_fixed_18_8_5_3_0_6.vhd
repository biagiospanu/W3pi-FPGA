...
entity conifer_xgboost_moons_accelerator_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_6 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of conifer_xgboost_moons_accelerator_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_6 is 
...
attribute shreg_extract : string;
    ...
    component conifer_xgboost_moons_accelerator_sparsemux_33_4_11_1_0_x IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_33_4_11_1_0_x_U56 : component conifer_xgboost_moons_accelerator_sparsemux_33_4_11_1_0_x
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "0000",
    ...
    icmp_ln4_32_fu_178_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_2280)) else "0";
    icmp_ln4_33_fu_184_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_F80)) else "0";
    icmp_ln4_34_fu_190_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_C600)) else "0";
    icmp_ln4_35_fu_196_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_18C)) else "0";
    icmp_ln4_36_fu_202_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_F539)) else "0";
    icmp_ln4_37_fu_208_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_1AE)) else "0";
    icmp_ln4_38_fu_214_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_2980)) else "0";
    icmp_ln4_39_fu_220_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_162)) else "0";
    icmp_ln4_40_fu_226_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_1280)) else "0";
    icmp_ln4_41_fu_232_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_10446)) else "0";
    icmp_ln4_42_fu_238_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_F000)) else "0";
    icmp_ln4_43_fu_244_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_300)) else "0";
    icmp_ln4_44_fu_250_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_2C4)) else "0";
    icmp_ln4_45_fu_256_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_2A80)) else "0";
    icmp_ln4_fu_172_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3780)) else "0";
