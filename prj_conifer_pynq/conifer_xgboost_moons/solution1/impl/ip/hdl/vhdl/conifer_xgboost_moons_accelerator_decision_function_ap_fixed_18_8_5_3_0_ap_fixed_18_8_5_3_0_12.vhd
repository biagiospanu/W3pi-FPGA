...
entity conifer_xgboost_moons_accelerator_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_12 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of conifer_xgboost_moons_accelerator_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_12 is 
...
attribute shreg_extract : string;
    ...
    component conifer_xgboost_moons_accelerator_sparsemux_31_4_11_1_0_x0 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_31_4_11_1_0_x0_U158 : component conifer_xgboost_moons_accelerator_sparsemux_31_4_11_1_0_x0
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "0000",
    ...
    icmp_ln4_144_fu_170_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FF3C)) else "0";
    icmp_ln4_145_fu_176_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_11E14)) else "0";
    icmp_ln4_146_fu_182_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_CD8D)) else "0";
    icmp_ln4_147_fu_188_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_366)) else "0";
    icmp_ln4_148_fu_194_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_9480)) else "0";
    icmp_ln4_149_fu_200_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_15ACF)) else "0";
    icmp_ln4_150_fu_206_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_3C80)) else "0";
    icmp_ln4_151_fu_212_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_18B)) else "0";
    icmp_ln4_152_fu_218_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_1245)) else "0";
    icmp_ln4_153_fu_224_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_13C7C)) else "0";
    icmp_ln4_154_fu_230_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_7680)) else "0";
    icmp_ln4_155_fu_236_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_C300)) else "0";
    icmp_ln4_156_fu_242_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FFC4)) else "0";
    icmp_ln4_fu_164_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_FA6)) else "0";
