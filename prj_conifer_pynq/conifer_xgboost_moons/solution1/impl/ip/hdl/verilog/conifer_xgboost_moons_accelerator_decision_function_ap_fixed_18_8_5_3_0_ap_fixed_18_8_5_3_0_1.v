...
module conifer_xgboost_moons_accelerator_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_1 (
        ap_clk,
        ap_rst,
        p_read1,
        p_read2,
...
assign icmp_ln4_12_fu_186_p2 = (($signed(p_read1_int_reg) < $signed(18'd2688)) ? 1'b1 : 1'b0);

assign icmp_ln4_13_fu_192_p2 = (($signed(p_read7_int_reg) < $signed(18'd260608)) ? 1'b1 : 1'b0);

assign icmp_ln4_14_fu_198_p2 = (($signed(p_read2_int_reg) < $signed(18'd4224)) ? 1'b1 : 1'b0);

assign icmp_ln4_15_fu_204_p2 = (($signed(p_read2_int_reg) < $signed(18'd5504)) ? 1'b1 : 1'b0);

assign icmp_ln4_16_fu_210_p2 = (($signed(p_read1_int_reg) < $signed(18'd2176)) ? 1'b1 : 1'b0);

assign icmp_ln4_17_fu_216_p2 = (($signed(p_read5_int_reg) < $signed(18'd1072)) ? 1'b1 : 1'b0);

assign icmp_ln4_18_fu_222_p2 = (($signed(p_read2_int_reg) < $signed(18'd2944)) ? 1'b1 : 1'b0);

assign icmp_ln4_19_fu_228_p2 = (($signed(p_read7_int_reg) < $signed(18'd261632)) ? 1'b1 : 1'b0);

assign icmp_ln4_20_fu_234_p2 = (($signed(p_read8_int_reg) < $signed(18'd304)) ? 1'b1 : 1'b0);

assign icmp_ln4_21_fu_240_p2 = (($signed(p_read4_int_reg) < $signed(18'd77350)) ? 1'b1 : 1'b0);

assign icmp_ln4_22_fu_246_p2 = (($signed(p_read1_int_reg) < $signed(18'd7040)) ? 1'b1 : 1'b0);

assign icmp_ln4_23_fu_252_p2 = (($signed(p_read8_int_reg) < $signed(18'd472)) ? 1'b1 : 1'b0);

assign icmp_ln4_24_fu_258_p2 = (($signed(p_read3_int_reg) < $signed(18'd50834)) ? 1'b1 : 1'b0);

assign icmp_ln4_fu_180_p2 = (($signed(p_read6_int_reg) < $signed(18'd9600)) ? 1'b1 : 1'b0);
...
endmodule //conifer_xgboost_moons_accelerator_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_1
