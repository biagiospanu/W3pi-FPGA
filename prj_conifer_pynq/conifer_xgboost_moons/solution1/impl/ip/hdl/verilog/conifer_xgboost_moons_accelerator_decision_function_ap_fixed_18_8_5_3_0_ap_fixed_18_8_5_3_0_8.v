...
module conifer_xgboost_moons_accelerator_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_8 (
        ap_clk,
        ap_rst,
        p_read1,
        p_read2,
...
assign icmp_ln4_11_fu_134_p2 = (($signed(p_read4_int_reg) < $signed(18'd401)) ? 1'b1 : 1'b0);

assign icmp_ln4_12_fu_140_p2 = (($signed(p_read6_int_reg) < $signed(18'd261512)) ? 1'b1 : 1'b0);

assign icmp_ln4_13_fu_146_p2 = (($signed(p_read3_int_reg) < $signed(18'd79315)) ? 1'b1 : 1'b0);

assign icmp_ln4_14_fu_152_p2 = (($signed(p_read3_int_reg) < $signed(18'd58635)) ? 1'b1 : 1'b0);

assign icmp_ln4_15_fu_158_p2 = (($signed(p_read6_int_reg) < $signed(18'd307)) ? 1'b1 : 1'b0);

assign icmp_ln4_16_fu_164_p2 = (($signed(p_read1_int_reg) < $signed(18'd5248)) ? 1'b1 : 1'b0);

assign icmp_ln4_17_fu_170_p2 = (($signed(p_read5_int_reg) < $signed(18'd46336)) ? 1'b1 : 1'b0);

assign icmp_ln4_fu_128_p2 = (($signed(p_read2_int_reg) < $signed(18'd1754)) ? 1'b1 : 1'b0);
...
endmodule //conifer_xgboost_moons_accelerator_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_8
