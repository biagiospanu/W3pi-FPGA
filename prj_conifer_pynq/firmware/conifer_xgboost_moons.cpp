...
#include "conifer_xgboost_moons.h"

void conifer_xgboost_moons(input_arr_t x, score_arr_t score){
...
void conifer_xgboost_moons_accelerator(int N, int& n_f, int& n_c, accelerator_input_t* x, accelerator_output_t* score){
