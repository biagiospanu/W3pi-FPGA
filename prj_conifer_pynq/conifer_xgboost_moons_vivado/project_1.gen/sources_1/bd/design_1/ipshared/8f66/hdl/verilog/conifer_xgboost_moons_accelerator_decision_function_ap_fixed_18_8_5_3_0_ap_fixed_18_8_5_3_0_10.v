...
module conifer_xgboost_moons_accelerator_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_10 (
        ap_clk,
        ap_rst,
        p_read1,
        p_read2,
...
assign icmp_ln4_124_fu_186_p2 = (($signed(p_read6_int_reg) < $signed(18'd61440)) ? 1'b1 : 1'b0);

assign icmp_ln4_125_fu_192_p2 = (($signed(p_read2_int_reg) < $signed(18'd26496)) ? 1'b1 : 1'b0);

assign icmp_ln4_126_fu_198_p2 = (($signed(p_read1_int_reg) < $signed(18'd2176)) ? 1'b1 : 1'b0);

assign icmp_ln4_127_fu_204_p2 = (($signed(p_read3_int_reg) < $signed(18'd95256)) ? 1'b1 : 1'b0);

assign icmp_ln4_128_fu_210_p2 = (($signed(p_read5_int_reg) < $signed(18'd2527)) ? 1'b1 : 1'b0);

assign icmp_ln4_129_fu_216_p2 = (($signed(p_read8_int_reg) < $signed(18'd136)) ? 1'b1 : 1'b0);

assign icmp_ln4_130_fu_222_p2 = (($signed(p_read5_int_reg) < $signed(18'd3322)) ? 1'b1 : 1'b0);

assign icmp_ln4_131_fu_228_p2 = (($signed(p_read6_int_reg) < $signed(18'd22144)) ? 1'b1 : 1'b0);

assign icmp_ln4_132_fu_234_p2 = (($signed(p_read3_int_reg) < $signed(18'd75470)) ? 1'b1 : 1'b0);

assign icmp_ln4_133_fu_240_p2 = (($signed(p_read7_int_reg) < $signed(18'd316)) ? 1'b1 : 1'b0);

assign icmp_ln4_134_fu_246_p2 = (($signed(p_read3_int_reg) < $signed(18'd86876)) ? 1'b1 : 1'b0);

assign icmp_ln4_135_fu_252_p2 = (($signed(p_read6_int_reg) < $signed(18'd44160)) ? 1'b1 : 1'b0);

assign icmp_ln4_136_fu_258_p2 = (($signed(p_read4_int_reg) < $signed(18'd868)) ? 1'b1 : 1'b0);

assign icmp_ln4_fu_180_p2 = (($signed(p_read1_int_reg) < $signed(18'd3456)) ? 1'b1 : 1'b0);
...
endmodule //conifer_xgboost_moons_accelerator_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_10
