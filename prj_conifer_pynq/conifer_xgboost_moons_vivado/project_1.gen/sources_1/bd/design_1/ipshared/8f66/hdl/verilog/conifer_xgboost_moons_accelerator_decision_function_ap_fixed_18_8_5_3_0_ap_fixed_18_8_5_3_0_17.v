...
module conifer_xgboost_moons_accelerator_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_17 (
        ap_clk,
        ap_rst,
        p_read1,
        p_read2,
...
assign icmp_ln4_80_fu_192_p2 = (($signed(p_read4_int_reg) < $signed(18'd73373)) ? 1'b1 : 1'b0);

assign icmp_ln4_81_fu_198_p2 = (($signed(p_read2_int_reg) < $signed(18'd13696)) ? 1'b1 : 1'b0);

assign icmp_ln4_82_fu_204_p2 = (($signed(p_read2_int_reg) < $signed(18'd10880)) ? 1'b1 : 1'b0);

assign icmp_ln4_83_fu_210_p2 = (($signed(p_read6_int_reg) < $signed(18'd3800)) ? 1'b1 : 1'b0);

assign icmp_ln4_84_fu_216_p2 = (($signed(p_read5_int_reg) < $signed(18'd283)) ? 1'b1 : 1'b0);

assign icmp_ln4_85_fu_222_p2 = (($signed(p_read5_int_reg) < $signed(18'd2407)) ? 1'b1 : 1'b0);

assign icmp_ln4_86_fu_228_p2 = (($signed(p_read7_int_reg) < $signed(18'd77568)) ? 1'b1 : 1'b0);

assign icmp_ln4_87_fu_234_p2 = (($signed(p_read1_int_reg) < $signed(18'd4736)) ? 1'b1 : 1'b0);

assign icmp_ln4_88_fu_240_p2 = (($signed(p_read8_int_reg) < $signed(18'd261656)) ? 1'b1 : 1'b0);

assign icmp_ln4_89_fu_246_p2 = (($signed(p_read4_int_reg) < $signed(18'd88482)) ? 1'b1 : 1'b0);

assign icmp_ln4_90_fu_252_p2 = (($signed(p_read2_int_reg) < $signed(18'd10112)) ? 1'b1 : 1'b0);

assign icmp_ln4_91_fu_258_p2 = (($signed(p_read5_int_reg) < $signed(18'd481)) ? 1'b1 : 1'b0);

assign icmp_ln4_92_fu_264_p2 = (($signed(p_read3_int_reg) < $signed(18'd2465)) ? 1'b1 : 1'b0);

assign icmp_ln4_93_fu_270_p2 = (($signed(p_read3_int_reg) < $signed(18'd59299)) ? 1'b1 : 1'b0);

assign icmp_ln4_fu_186_p2 = (($signed(p_read1_int_reg) < $signed(18'd6528)) ? 1'b1 : 1'b0);
...
endmodule //conifer_xgboost_moons_accelerator_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_17
