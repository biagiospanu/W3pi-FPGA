...
module conifer_xgboost_moons_accelerator_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_16 (
        ap_clk,
        ap_rst,
        p_read1,
        p_read2,
...
assign icmp_ln4_100_fu_198_p2 = (($signed(p_read3_int_reg) < $signed(18'd3399)) ? 1'b1 : 1'b0);

assign icmp_ln4_101_fu_204_p2 = (($signed(p_read2_int_reg) < $signed(18'd78284)) ? 1'b1 : 1'b0);

assign icmp_ln4_102_fu_210_p2 = (($signed(p_read4_int_reg) < $signed(18'd3143)) ? 1'b1 : 1'b0);

assign icmp_ln4_103_fu_216_p2 = (($signed(p_read2_int_reg) < $signed(18'd61178)) ? 1'b1 : 1'b0);

assign icmp_ln4_94_fu_162_p2 = (($signed(p_read6_int_reg) < $signed(18'd260608)) ? 1'b1 : 1'b0);

assign icmp_ln4_95_fu_168_p2 = (($signed(p_read7_int_reg) < $signed(18'd49)) ? 1'b1 : 1'b0);

assign icmp_ln4_96_fu_174_p2 = (($signed(p_read1_int_reg) < $signed(18'd2176)) ? 1'b1 : 1'b0);

assign icmp_ln4_97_fu_180_p2 = (($signed(p_read2_int_reg) < $signed(18'd104174)) ? 1'b1 : 1'b0);

assign icmp_ln4_98_fu_186_p2 = (($signed(p_read2_int_reg) < $signed(18'd68435)) ? 1'b1 : 1'b0);

assign icmp_ln4_99_fu_192_p2 = (($signed(p_read5_int_reg) < $signed(18'd32640)) ? 1'b1 : 1'b0);

assign icmp_ln4_fu_156_p2 = (($signed(p_read6_int_reg) < $signed(18'd1536)) ? 1'b1 : 1'b0);
...
endmodule //conifer_xgboost_moons_accelerator_decision_function_ap_fixed_18_8_5_3_0_ap_fixed_18_8_5_3_0_16
